...
import { LostReportForm } from '../components/report/LostReportForm';
import { FoundReportForm } from '../components/report/FoundReportForm';
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-rose-500/10 flex items-center justify-center text-rose-400 text-2xl group-hover:bg-rose-500/20 transition-colors">
                🔍
              </div>
              <div>
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-400 text-2xl group-hover:bg-emerald-500/20 transition-colors">
                📦
              </div>
              <div>
    ...
    return (
      <div className="min-h-screen bg-brand-bg flex flex-col">
        <main
          className={[
            'flex-1 flex pb-24',
            isChoose ? 'items-center justify-center' : 'items-start justify-center pt-6',
          ].join(' ')}
        >
          {isChoose ? this.renderChoose() : this.renderForm()}
        </main>
        <BottomNavbar />
      </div>
    );
