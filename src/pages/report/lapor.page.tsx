    ...
    return (
      <div className="flex flex-col items-center gap-6 w-full max-w-sm lg:max-w-lg px-6">
        <div className="text-center">
          <h1 className="text-xl font-bold text-brand-text">Buat Laporan</h1>
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold text-brand-text text-sm">Lapor Hilang</p>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold text-brand-text text-sm">Lapor Temuan</p>
