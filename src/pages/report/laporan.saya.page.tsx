      ...
      <div className="min-h-screen bg-brand-bg flex flex-col lg:pl-14">
        ...
        <div className="w-full max-w-3xl mx-auto flex flex-col flex-1">
          ...
          <div className="flex items-center gap-3 px-4 pt-5 pb-3 lg:pt-8">
            <button onClick={() => this.props.navigate(-1)} className="w-9 h-9 flex items-center justify-center rounded-xl bg-brand-surface-alt text-brand-muted hover:text-white transition-colors flex-shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="15 18 9 12 15 6" />
              </svg>
            </button>
            <div>
              <h1 className="text-white font-bold text-lg lg:text-2xl leading-tight">Laporan Saya</h1>
